...
const run = async () => {
	...
	console.log(new Date(),"Test run @molfar/service-manticore")
	...
	container.hold(servicePath, "@molfar/service-manticore")
	const service = await container.startInstance(container.getService(s => s.name == "@molfar/service-manticore"))
